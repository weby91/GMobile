...
import com.webster.gmobile.adapter.NavigationDrawerAdapter;
import com.webster.gmobile.model.NavDrawerItem;
...
public class FragmentDrawer extends Fragment {
    ...
    public static List<NavDrawerItem> getData() {
        ...
        // preparing navigation drawer itemsf
    ...
    private void getSharedPreferences(){
        prefs = getActivity().getSharedPreferences("utilities", 0);
    }
    //endregion
        ...
        try {
            ...
            mDrawerToggle = new ActionBarDrawerToggle(getActivity(), drawerLayout, toolbar, R.string.drawer_open, R.string.drawer_close) {
                ...
                public void onDrawerOpened(View drawerView) {
                    //Here's when Drawer / Menu Bar Opened / Expanded
                    super.onDrawerOpened(drawerView);
                    getActivity().invalidateOptionsMenu();

                    getSharedPreferences();
                    SharedPreferences.Editor prefsEditor = prefs.edit();
                    prefsEditor.putString("isExit", "No");
                    prefsEditor.commit();
                    ...
                    getView().setOnKeyListener(new View.OnKeyListener() {
                        ...
                        public boolean onKey(View v, int keyCode, KeyEvent event) {
                            Log.d("com.webster.gmobile.activity.FragmentDrawer", "onKeyListener Trigerred ");
                ...
                public void onDrawerClosed(View drawerView) {
                    ...
                    getSharedPreferences();
                    SharedPreferences.Editor prefsEditor = prefs.edit();
                    prefsEditor.putString("isExit", "Yes");
                    prefsEditor.commit();
                }
            ...
            Log.e("com.webster.gmobile.activity.FragmentDrawer", "method setUp");
        }
    }
    //endregion
